...
(function (angular) {
    ...
    }]).controller('AppCtrl', ['$rootScope', '$state', function ($rootScope, $state) {}]).controller('HomeCtrl', ['$scope', '$document', '$location', '$state', 'smoothScroll', function ($scope, $document, $location, $state, smoothScroll) {}]).controller('ContactCtrl', ['$scope', '$http', 'AlertService', function ($scope, $http, AlertService) {
